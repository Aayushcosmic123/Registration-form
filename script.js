...
document.querySelector('input[name="birth_month"]').addEventListener('change' , function(){
     const date = new Date();
...
document.querySelector('input[name="birth_year"]').addEventListener('change' , function(){
